                     ...
                     )
{
    ...
    */
    ...
    cout << "Head size: (after remove) " << Head.size() << endl;
                         ...
                         set<pair<NS, NS> > & truncated )
{
    ...
    */
    ...
    for ( auto pinner : PIN )
    {
        ...
        /*
        frontIS0.insert( ppx0 );
        frontIS1.insert( ppx1 );
        frontIS2.insert( ppx2 );
        frontIS3.insert( ppx3 );
