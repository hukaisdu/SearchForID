...
typedef std::array<Nibble, 32> NS; // state as Nibbles
typedef std::array<Bit, 128> BS; // state as Bits
...
void State_to_Word( const NS &, Word&, Word&, Word&, Word&, Word&, Word&, Word&, Word& );
//void Word_to_State( Word, Word, Word, Word, NS &  );
void Word_to_State( Word, Word, Word, Word, Word, Word, Word, Word, NS &  );
