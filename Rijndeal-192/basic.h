...
typedef std::array<Nibble, 24> NS; // state as Nibbles
...
void State_to_Word( const NS &, Word&, Word&, Word&, Word&, Word &, Word & );
void Word_to_State( Word, Word, Word, Word, Word, Word, NS &  );
...
void printS( const NS &, std::ostream & os = std::cout );
